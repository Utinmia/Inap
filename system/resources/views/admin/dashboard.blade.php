...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4><strong>Hi, Selamat Datang!</strong> {{ session('admin')->nama }}</h4>
        ...
        <div class="row">
            {{-- <div class="col-lg-12">
                <div class="alert alert-success solid ">
                    <strong>Selamat Datang!</strong> {{session('admin')->nama}}.
                </div>
            </div> --}}
                                    ...
                                    @foreach ($kamar_by_tipe as $tipe_kamar => $kamars)
                                        ...
                                        <div class="col-lg-6">
                                            <h6
                                                ...
                                                {{ $tipe_kamar }}</h6>
                                            <span style="color: #343a40;">Total Kamar : {{ $totalKamar }} Kamar</span>
                                            <br>
        ...
        <div class="row">
            ...
            @if (session('admin')->role == 'Penginapan')
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
            ...
            @elseif (session('admin')->role == 'Administrator')
                    ...
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            ...
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Total Admin</div>
                                <div class="stat-digit">{{$total_admin}}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            ...
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Total Penginapan</div>
                                <div class="stat-digit">{{$total_penginapan}}</div>
                            </div>
                        </div>
                    </div>
                </div>
